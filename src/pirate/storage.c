...
const char storage_fat_type_labels[][8] = { "FAT12", "FAT16", "FAT32", "EXFAT", "UNKNOWN" };
...
uint8_t storage_format(void) {
    static_assert(FF_MAX_SS <= BIG_BUFFER_SIZE,
                  "BIG_BUFFER_SIZE must be at least FF_MAX_SS for this allocation to succeed.");
